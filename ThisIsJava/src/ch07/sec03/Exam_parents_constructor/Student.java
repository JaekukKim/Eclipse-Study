...
public class Student extends People {
	...
	public Student(String name, String ssn,int stuNo) { // 여기까지만 썼을때 여기서도 빨간줄이 뜨는 이유는 상위 클래스에 기본생성자가 없기 때문이다.
		super(name, ssn, stuNo); // 즉 super(매개값);으로 상위 클래스에 있는 생성자를 호출해주면 문제가 해결이 된다. 이것이 방식 1.
		this.stuNo = stuNo; // 방식 2는 People.java 파일로 넘어가도록 하자.
